...
namespace MapTeleport
{
    public partial class ModEntry : Mod
    {
        ...
        public override void Entry(IModHelper helper)
        {
            ...
            helper.ConsoleCommands.Add("mtp_edit", "Syntax: 'mtp_edit name x y'. Must include valid key. If editing to a location other than where the player is currently standing, please include the other 2 parameters.", (command, args) => EditLocations(args));
